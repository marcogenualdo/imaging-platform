...
type homemgenualdoDocumentssapsrcbiosrcpagesindexJs3840892647QueryVariables = Exact<{ [key: string]: never; }>;


type homemgenualdoDocumentssapsrcbiosrcpagesindexJs3840892647Query = { readonly news: { readonly nodes: ReadonlyArray<{ readonly childMarkdownRemark: Maybe<(
...
type homemgenualdoDocumentssapsrcbiosrcpagesnewsJs1705985796QueryVariables = Exact<{ [key: string]: never; }>;


type homemgenualdoDocumentssapsrcbiosrcpagesnewsJs1705985796Query = { readonly news: { readonly nodes: ReadonlyArray<(
      Pick<File, 'birthTime'>
...
type Unnamed_1_Query = { readonly banner: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
...
type Unnamed_3_Query = { readonly banner: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> };
